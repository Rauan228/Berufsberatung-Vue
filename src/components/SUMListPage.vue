      ...
      <div class="main-content">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">Квалификации</li>
          </ol>
        </nav>
...
export default {
  ...
  methods: {
    ...
    async fetchQualifications(specialtyId) {
      ...
      this.error = null;
      try {
        console.log("Загрузка квалификаций для specialty_id:", specialtyId);
        const response = await axios.get(
          `http://localhost:8000/api/qualifications?specialty_id=${specialtyId}`
        );
